	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options'   => array(
							   ...
							   ) + \Thim_EL_Kit\Functions::instance()->get_pages_loop_item( 'post' ),
				'condition' => array(
					'build_loop_item' => 'yes',
				),
			)
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'all',
				'type'    => Controls_Manager::SELECT,
				'options' => \Thim_EL_Kit\Elementor::get_cat_taxonomy( 'category',
					array( 'all' => esc_html__( 'All', 'thim-elementor-kit' ) ) ),
			)
		);
