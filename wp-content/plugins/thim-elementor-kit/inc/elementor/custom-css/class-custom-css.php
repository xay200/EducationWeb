...
class Custom_CSS {
	...
	public function register_controls( $element, $section_id, $args ) {
		if ( $section_id == 'section_custom_css_pro' ) {
			...
			$element->start_controls_section(
				'section_custom_css',
				array(
					'label' => esc_html__( 'Custom CSS', 'thim-elementor-kit' ),
			...
			$element->add_control(
				'custom_css_title',
				array(
					'raw'  => esc_html__( 'Add your own custom CSS here', 'thim-elementor-kit' ),
	...
	public function enqueue_editor_scripts() {
		wp_enqueue_script( 'thim-ekit-editor-custom-css-js',
			THIM_EKIT_PLUGIN_URL . 'inc/elementor/custom-css/assets/editor.js', array( 'jquery' ), '', true );
	}
}
