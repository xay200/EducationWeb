...
if ( ! class_exists( 'Thim_Plugin' ) ) {
	class Thim_Plugin {
		...
		public function __construct( $slug = '', $is_wporg = false ) {
			...
			$this->messages = array( esc_attr__( 'Something went wrong!', 'edu-press' ) );
		...
		public function get_text_status() {
			$arrText = array(
				'active'        => esc_attr__( 'Active', 'edu-press' ),
				'inactive'      => esc_attr__( 'Inactive', 'edu-press' ),
				'not_installed' => esc_attr__( 'Not Installed', 'edu-press' )
			);
		...
		public function update() {
			do_action( 'thim_core_pre_upgrade_plugin', $this );
